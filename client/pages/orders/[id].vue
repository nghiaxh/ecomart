  ...
  <div class="mx-auto max-w-3xl px-4 py-8 sm:px-6">
    <div v-if="order">
      <div class="flex items-center gap-3">
        <UButton icon="i-heroicons-arrow-left" color="gray" variant="ghost" to="/orders" />
        <div>
      ...
      <section class="mt-6 rounded-2xl border border-green-100 bg-white p-6">
        ...
        <div class="mt-6 space-y-2 border-t border-green-50 pt-4 text-sm">
          ...
          <div class="flex justify-between text-green-600"><span>Eco điểm nhận được</span><span>+{{ order.ecoPointsEarned }} Eco</span></div>
