  ...
  <div class="mx-auto max-w-5xl px-4 py-8 sm:px-6">
    ...
    <div v-else-if="orders.length" class="mt-8 space-y-4">
      ...
      >
        ...
        <p v-if="o.ecoPointsEarned > 0" class="mt-2 text-xs font-semibold text-green-600">+{{ o.ecoPointsEarned }} Eco</p>
      </NuxtLink>
    </div>

    <div v-else class="py-24 text-center">
      <UIcon name="i-heroicons-receipt-percent" class="mx-auto mb-4 h-16 w-16 text-green-200" />
      <p class="text-gray-500">Bạn chưa có đơn hàng nào.</p>
      <UButton to="/products" color="green" class="mt-4" label="Mua sắm ngay" />
    </div>
