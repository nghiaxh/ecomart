  ...
  <div class="mx-auto max-w-7xl px-4 py-8 sm:px-6">
    ...
    <div class="mb-6 flex flex-wrap gap-2">
      ...
      <template v-for="c in categories" :key="c.id">
        <UButton
          :color="filters.category === c.slug ? 'green' : 'gray'"
        ...
        <UButton
          ...
          :key="child.id"
          :color="filters.category === child.slug ? 'green' : 'gray'"
    ...
    <div class="mb-8 grid gap-3 rounded-2xl border border-green-100 bg-white p-4 md:grid-cols-5">
      <UInput v-model="filters.q" icon="i-heroicons-magnifying-glass" placeholder="Tìm sản phẩm..." />
      ...
      <UButton color="green" icon="i-heroicons-adjustments-horizontal" label="Lọc" @click="applyFilters" />
      <UButton color="gray" variant="ghost" label="Bỏ lọc" @click="clearFilters" />
    </div>
    ...
    <div v-else class="py-20 text-center text-gray-400">
      ...
      <UButton class="mt-4" color="green" variant="soft" label="Bỏ lọc" @click="clearFilters" />
    </div>
